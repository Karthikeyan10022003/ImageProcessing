...
# ===== SETTINGS =====
source_dir = Path(r"D:\img_processing_trial\images")  # Your current images folder
output_dir = Path(r"D:\img_processing_trial\vending_dataset")  # YOLOv8 dataset output folder
